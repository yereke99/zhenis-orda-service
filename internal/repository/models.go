...
type Receipt struct {
	...
	ReceiptTransactionKey string     `json:"receipt_transaction_key,omitempty"`
	...
	ParsedRecipientBIN    string     `json:"parsed_recipient_bin,omitempty"`
	ExpectedRecipientBIN  string     `json:"expected_recipient_bin,omitempty"`
